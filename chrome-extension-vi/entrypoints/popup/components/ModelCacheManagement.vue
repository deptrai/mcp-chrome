<template>
  <div class="model-cache-section">
    <h2 class="section-title">Quản lý Cache Mô hình</h2>

    <!-- Cache Statistics Grid -->
    <div class="stats-grid">
      <div class="stats-card">
        <div class="stats-header">
          <p class="stats-label">Kích thước Cache</p>
      ...
      <div class="stats-card">
        <div class="stats-header">
          <p class="stats-label">Số mục Cache</p>
    ...
    <div v-if="cacheStats && cacheStats.entries.length > 0" class="cache-details">
      <h3 class="cache-details-title">Chi tiết Cache</h3>
        ...
        <div v-for="entry in cacheStats.entries" :key="entry.url" class="cache-entry">
          <div class="entry-info">
            ...
            <div class="entry-details">
              ...
              <span v-if="entry.expired" class="entry-expired">Đã hết hạn</span>
            </div>
          </div>
        </div>
      </div>
